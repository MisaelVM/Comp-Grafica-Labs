...
SET cxxFiles=main.cpp GL/Shader.cpp GL/VertexBuffer.cpp GL/VertexArray.cpp GL/ElementBuffer.cpp GL/Texture.cpp Rubik/Solver/rubik_cube_3basic_solver.cpp Rubik/Solver/rubik_cube.cpp Rubik/RubiksCube.cpp
